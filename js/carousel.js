...
// all slides should have the seam width
// below gets the dimensions of the slide
...
// BEST --> create a function and pass that func to the forEach
...
nextButton.addEventListener('click', e => {
    ...
    // get index number for next slide
